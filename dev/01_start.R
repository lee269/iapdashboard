...
golem::fill_desc(
  pkg_name = "iapdashboard", # The Name of the package containing the App 
  pkg_title = "IAP dashboard", # The Title of the package containing the App 
  pkg_description = "A shiny dashboard of trade data.", # The Description of the package containing the App 
